...
export const drawHorizontalRuler = (ctx: any, start: any, shadow: any, options: any) => {
...
export const drawVerticalRuler = (ctx: any, start: any, shadow: any, options: any) => {
    const { scale, width, height, canvasConfigs } = options
    const { bgColor, fontColor, shadowColor, ratio, longfgColor, shortfgColor } = canvasConfigs
